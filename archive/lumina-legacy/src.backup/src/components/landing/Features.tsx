    ...
    <section id="features" className="py-24 md:py-32 px-6">
      <div ref={ref} className="max-w-6xl mx-auto opacity-0">
        <div className="text-center mb-14 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-gradient-royal-gold">Everything your team needs in one studio.</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f, i) => {
            const Icon = f.icon;
            return (
              <div key={f.title} className={`glass-panel-landing p-6 rounded-2xl ${luminaFrame(i)} transition-all duration-500 ease-fluid hover:-translate-y-1`}>
