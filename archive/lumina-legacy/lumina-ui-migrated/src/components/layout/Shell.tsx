  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 35%, hsl(var(--background) / 0.55), hsl(var(--background) / 0.82) 80%)",
        }}
      />
      {/* Vignette */}
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 50%, transparent 45%, hsl(230 25% 2% / 0.6) 100%)",
        }}
      />
