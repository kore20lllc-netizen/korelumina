...
import { Plus, Search, Filter, Globe, AppWindow, BarChart3, Brain, MoreHorizontal } from "lucide-react";
...
const typeIcon: Record<BuildIntent, any> = {
  website: Globe, webapp: AppWindow, dashboard: BarChart3, "ai-tool": Brain, import: Globe,
};
const typeLabel: Record<BuildIntent, string> = {
  website: "Website", webapp: "Web App", dashboard: "Dashboard", "ai-tool": "AI Tool", import: "Import",
};
const accentMap = {
...
export function DashboardView() {
  const { projects, setView, setActiveProject } = useWorkspace();
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-10 md:py-14">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 anim-in">
          ...
          <div className="flex items-center gap-2">
            ...
            <LuminaButton variant="ghost" size="md" className="hidden md:inline-flex">
                ...
                <div className="absolute inset-x-0 bottom-0 p-4">
                  <div className="flex items-center justify-between">
                    <div className="min-w-0">
                      <div className="font-display font-semibold text-[14px] tracking-tight truncate">{p.name}</div>
