...
const luminaButton = cva(
  ...
  "active:scale-[0.98]",
  {
    variants: {
      variant: {
        primary:
          "text-primary-foreground bg-button-lumina shadow-[0_4px_20px_-6px_hsl(var(--violet)/0.55),inset_0_1px_0_hsl(220_20%_100%/0.18)] " +
          "hover:shadow-[0_6px_28px_-6px_hsl(var(--violet)/0.7),inset_0_1px_0_hsl(220_20%_100%/0.22)] hover:brightness-[1.06]",
        ghost:
