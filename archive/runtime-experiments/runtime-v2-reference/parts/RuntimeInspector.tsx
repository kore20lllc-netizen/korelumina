  ...
  return (
    ...
    >
      ...
      >
        <TabsList
          className={cn(
            "mx-5 mt-4 self-start rounded-2xl border p-1",
...
function DetailGroup({
  ...
  return (
    <div
      className={cn(
        "mt-3 overflow-hidden border divide-y",
        "[border-radius:var(--lumina-radius-inner)]",
        "[border-color:var(--lumina-border-standard)]",
        "[background:var(--lumina-surface-compact)]",
        "[&>*]:[border-color:var(--lumina-border-standard)]",
  ...
  return (
    <div className="flex gap-3 px-4 py-3.5">
      ...
      >
        ...
        <span
          className={cn(
            "min-w-0 text-xs font-medium tabular-nums text-foreground",
            stacked
              ? "break-words"
              : "truncate text-right",
          )}
...
function StatusCheck({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between gap-4 border px-3 py-3",
        "[border-radius:var(--lumina-radius-inner)]",
        "[border-color:var(--lumina-border-standard)]",
        "[background:var(--lumina-surface-compact)]",
      )}
...
function EmptyDetail({
  ...
  return (
    <div
      className={cn(
        "border px-4 py-5 text-center text-xs text-muted-foreground",
        "[border-radius:var(--lumina-radius-inner)]",
        "[border-color:var(--lumina-border-standard)]",
        "[background:var(--lumina-surface-compact)]",
      )}
