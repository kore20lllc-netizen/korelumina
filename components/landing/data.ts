...
export const trustBadges = [
  ...
  "Bring your own FolderGit2 and Supabase",
  "Deploy anywhere",
];
...
export const socialMetrics = [
  {
    ...
    summary: "Drop a ZIP, paste a FolderGit2 URL, or connect a repo — KoreLumina indexes it in seconds.",
    details: [
  ...
  },
  {
    ...
    details: [
      "Connect FolderGit2, Supabase, Vercel, AWS — your keys stay yours.",
...
export const howItWorks = [
  { icon: Upload, title: "Import", body: "Drop a repo, paste a FolderGit2 URL, or start from a blank template. KoreLumina parses and indexes your project in seconds." },
...
export const features = [
  ...
  { icon: CloudUpload, title: "Deploy anywhere", body: "Push to your own cloud — FolderGit2, Supabase, Vercel, AWS — KoreLumina never holds your keys hostage." },
...
export const faq = [
  { q: "Does KoreLumina lock me into your infrastructure?", a: "No. Bring your own FolderGit2, Supabase, and cloud — KoreLumina is the operating system that connects them. Your code, your keys, your data." },
  { q: "Can I import an existing project?", a: "Yes. Drop a ZIP, paste a FolderGit2 URL, or connect a repo. Repo Intelligence indexes the codebase so AI works with real context." },
