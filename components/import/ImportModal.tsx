...
import { FolderGit2, Upload, FolderOpen, LayoutTemplate, Loader2, FileCode2, Package, CheckCircle2, AlertCircle, X, FileArchive, Ban, Trash2, Timer, Sparkles } from "lucide-react";
...
const tabs: { id: Tab; label: string; Icon: any }[] = [
  { id: "github",    label: "FolderGit2",    Icon: FolderGit2 },
  { id: "git",       label: "Git URL",   Icon: FolderGit2 },
              ...
              {(tab === "github" || tab === "git") && (
                <div className="space-y-3">
                  <label className="block text-[11px] uppercase tracking-widest text-muted-foreground">
                    {tab === "github" ? "FolderGit2 URL" : "Public Git URL"}
                  </label>
                  <input
                    value={url}
