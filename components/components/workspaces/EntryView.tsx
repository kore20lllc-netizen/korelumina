import { Globe, AppWindow, BarChart3, Brain, FolderGit2, Sparkles, Wand2, Palette, Code2, ArrowRight, Smartphone, Upload, LayoutTemplate, Wand, Pencil, Plus, Trash2, RotateCcw } from "lucide-react";
...
const PROMPT_PHRASES = [
  ...
  "Paste a FolderGit2 repository URL…",
...
const DEFAULT_CHIPS_MATRIX: DefaultsMatrix = {
  any: {
    ai: [
      ...
      { label: "From FolderGit2 repo",   prompt: "https://github.com/" },
    ],
    designer: [
  ...
  import: {
    ai: [
      { label: "Paste FolderGit2 URL",   prompt: "https://github.com/" },
    ...
    developer: [
      ...
      { label: "CI + lint",          prompt: "Add a FolderGit2 Actions workflow running typecheck, lint, and tests on PRs." },
    ],
  },
};
...
const intents: { id: BuildIntent; label: string; desc: string; icon: any; accent: "violet" | "magenta" | "cyan" | "gold" }[] = [
  ...
  { id: "import", label: "Continue", desc: "Import from FolderGit2", icon: FolderGit2, accent: "violet" },
];
...
export function EntryView() {
  ...
  const buildOptions = [
    ...
    { id: "github",   label: "Import FolderGit2 repo",  desc: "Clone and continue",       Icon: FolderGit2,          onClick: () => setImportOpen(true) },
