import { Sparkles, Send, Wand2, Image as ImageIcon, Layers } from "lucide-react";
...
export function PromptComposer({ prompt, onPromptChange, onGenerate, generating }: PromptComposerProps) {
  return (
    <>
