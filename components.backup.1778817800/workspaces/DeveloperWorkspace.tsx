...
import {
  ...
  Play, Save, RotateCcw, Wand2, X, Circle, Crosshair, Lock, LockOpen, Eraser, HelpCircle, Keyboard, Search,
} from "lucide-react";
...
export function DeveloperWorkspace() {
  ...
  const { setBottomDockOpen, setCommandOpen } = useWorkspace();
    ...
    <div className="flex-1 min-h-0 flex flex-col gap-3 p-4 md:p-6">
      ...
      <div className="flex items-center gap-2 anim-in">
        ...
        <div className="flex-1" />
          <LuminaButton size="sm" variant="glow" onClick={() => setAiOpen(true)}>
          <Wand2 className="h-3.5 w-3.5" />AI Assist
        </LuminaButton>
      </div>
