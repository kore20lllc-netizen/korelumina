    ...
    <section id="architecture" className="py-24 md:py-32 px-6 relative">
      <div ref={ref} className="max-w-6xl mx-auto opacity-0">
        <div className="text-center mb-14 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-5 text-gradient-royal-gold">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {architectureSystems.map((s, i) => {
            const Icon = s.icon;
            return (
              <div key={s.title} className="glass-panel-landing p-6 rounded-2xl group transition-all duration-500 ease-fluid hover:-translate-y-1">
