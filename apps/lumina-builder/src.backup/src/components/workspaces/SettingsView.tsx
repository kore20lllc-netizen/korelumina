...
import { auth, billing, team as teamProvider } from "@/providers/registry";
              ...
              <Section title="Security">
                ...
                <Row label="Reset & re-seed (dev)">
                  <LuminaButton
                    ...
                    size="sm"
                    onClick={() => {
                      if (confirm("Wipe all local app data and re-seed demo content? This reloads the page.")) resetSeed();
                    }}
                  >
                    Reset data
                  </LuminaButton>
