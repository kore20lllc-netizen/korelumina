import {
  ...
  BookOpen, ShieldCheck, Gauge, Crown, ChevronDown, LogOut, User as UserIcon,
} from "lucide-react";
...
import { NavigationItem, NavigationSection, NavigationFooter } from "@/components/lumina/navigation";
            ...
            return (
              <div key={item.label} className="flex flex-col items-center w-full">
                ...
                <NavigationItem
                  ...
                  icon={<Icon />}
                  badge={item.badge}
                  active={activeLabel ? activeLabel === item.label : item.active}
                  compact={true}
                  onClick={() => {
